...
import {View,Text, StyleSheet, ImageBackground, StatusBar, SafeAreaView, Image, Alert, Platform} from 'react-native'
import MapView, {Marker} from 'react-native-maps';
import axios from "axios";
export default class IsLocation extends Component{
  constructor(props){
    super(props);
    this.state = {
      location: {}
  ...
  render(){
    ...
    return(
     ...
     <ImageBackground source = {require('../assets/bg_image.png')} style = {styles.backgroundImage}>
      ...
      <Text style = {styles.titleText}> Is Location </Text>
      </View>
